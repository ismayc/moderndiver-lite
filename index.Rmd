...
link-citations: yes
github-repo: ismayc/moderndiver-lite
...
The source of the book is available [here](https://github.com/ismayc/moderndiver-lite) and was built with versions of R packages (and their dependent packages) given below.  This may not be of importance for initial readers of this book, but the hope is you can reproduce a duplicate of this book by installing these versions of the packages.
